...
select book_id, book_uuid, author_id, isbn, book_type, title, yr, available, tags from books where title = ? and yr = ?
`
...
select book_id, book_uuid, author_id, isbn, book_type, title, yr, available, tags from books where book_id = ?
`
