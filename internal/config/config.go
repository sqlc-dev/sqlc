...
type SQLGo struct {
	...
	InterfaceName             string            `json:"output_interface_name,omitempty" yaml:"output_interface_name"`
	QueriesStructName         string            `json:"output_queries_struct_name,omitempty" yaml:"output_queries_struct_name"`
