...
type v1PackageSettings struct {
	...
	SkipStructRename    bool       `json:"skip_struct_rename" yaml:"skip_struct_rename"`
	RenameJSONTags      bool       `json:"rename_json_tags" yaml:"rename_json_tags"`
		...
		conf.SQL = append(conf.SQL, SQL{
			...
			Gen: SQLGen{
				Go: &SQLGo{
					...
					RenameJSONTags:      pkg.RenameJSONTags,
					SkipStructRename:    pkg.SkipStructRename,
					Package:             pkg.Name,
					Out:                 pkg.Path,
