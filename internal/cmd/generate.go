...
func parse(name, dir string, sql config.SQL, combo config.CombinedSettings, parserOpts dinosql.Opts, stderr io.Writer) (dinosql.Generateable, bool) {
	switch sql.Engine {
