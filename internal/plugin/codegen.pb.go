...
var file_plugin_codegen_proto_depIdxs = []int32{
	...
	8,  // 15: plugin.Query.update_table:type_name -> plugin.Identifier
	8,  // 16: plugin.Query.delete_from_table:type_name -> plugin.Identifier
	9,  // 17: plugin.Parameter.column:type_name -> plugin.Column
	...
	10, // 20: plugin.GenerateRequest.queries:type_name -> plugin.Query
	0,  // 21: plugin.GenerateResponse.files:type_name -> plugin.File
	12, // 22: plugin.CodegenService.Generate:input_type -> plugin.GenerateRequest
	13, // 23: plugin.CodegenService.Generate:output_type -> plugin.GenerateResponse
