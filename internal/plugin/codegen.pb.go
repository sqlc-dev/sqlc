...
type Parameter struct {
	...
	// named is set when the query binds the parameter by the name in column
	// rather than by position: SQL Server's and Spanner's @name and
	// ClickHouse's {name:Type}, which their drivers take as sql.Named.
	Named bool `protobuf:"varint,3,opt,name=named,proto3" json:"named,omitempty"`
}
...
func (x *Parameter) GetNamed() bool {
	if x != nil {
		return x.Named
	}
	return false
...
var file_plugin_codegen_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x62, 0x6c, 0x65, 0x22, 0x61, 0x0a, 0x09, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74,
	...
	0x6d, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x6e, 0x61, 0x6d, 0x65, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x05, 0x6e, 0x61, 0x6d, 0x65, 0x64, 0x22, 0x87, 0x02, 0x0a, 0x0f, 0x47, 0x65, 0x6e,
