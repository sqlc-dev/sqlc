...
type VetQuery struct {
	...
	Params []*VetParameter `protobuf:"bytes,5,rep,name=params,json=parameters,proto3" json:"params,omitempty"`
...
func (x *VetQuery) GetEngine() string {
	if x != nil {
		return x.Engine
	}
	return ""
...
func (x *VetQuery) GetPath() string {
	if x != nil {
		return x.Path
	}
	return ""
...
=======
	...
	0x72, 0x22, 0xa0, 0x01, 0x0a, 0x08, 0x56, 0x65, 0x74, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x10,
...
var file_plugin_codegen_proto_goTypes = []interface{}{
	...
	(*VetQuery)(nil),        // 19: plugin.VetQuery
...
var file_plugin_codegen_proto_depIdxs = []int32{
	...
	20, // 2: plugin.ParsedGoType.struct_tags:type_name -> plugin.ParsedGoType.StructTagsEntry
