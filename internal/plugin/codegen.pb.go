...
// TypeExpr is a column's type as an expression: its name, whether a value
// of it may be null, and its arguments — the (10, 2) of decimal(10, 2), the
// element of array(integer), the fields of struct(a: integer). It is set
// only when the analysis core typed the column; the flat description in
// Column (type, not_null, is_array, array_dims, length, unsigned) is set
// either way.
type TypeExpr struct {
	...
	Args     []*TypeArg `protobuf:"bytes,3,rep,name=args,proto3" json:"args,omitempty"`
}
...
func (x *TypeExpr) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *TypeExpr) GetNullable() bool {
	if x != nil {
		return x.Nullable
	}
	return false
...
func (x *TypeExpr) GetArgs() []*TypeArg {
	if x != nil {
		return x.Args
	}
	return nil
...
// TypeArg is one argument of a TypeExpr. Exactly one of the values is set:
// a type for array(integer), an integer for varchar(20), a boolean or a
// string for a dialect that takes them, or an identifier for a bare word
// that is not a type, such as the max of nvarchar(max). A label names the
// argument, as the fields of struct(a: integer, b: varchar) are named.
type TypeArg struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	//	*TypeArg_StringValue
	//	*TypeArg_Ident
	Value isTypeArg_Value `protobuf_oneof:"value"`
}

func (x *TypeArg) Reset() {
	*x = TypeArg{}
	if protoimpl.UnsafeEnabled {
...
func (x *TypeArg) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TypeArg) ProtoMessage() {}

func (x *TypeArg) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_codegen_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TypeArg.ProtoReflect.Descriptor instead.
func (*TypeArg) Descriptor() ([]byte, []int) {
	return file_plugin_codegen_proto_rawDescGZIP(), []int{10}
}

func (x *TypeArg) GetLabel() string {
	if x != nil {
		return x.Label
	}
	return ""
...
func (m *TypeArg) GetValue() isTypeArg_Value {
	if m != nil {
		return m.Value
	}
	return nil
...
func (x *TypeArg) GetType() *TypeExpr {
	if x, ok := x.GetValue().(*TypeArg_Type); ok {
		return x.Type
	}
	return nil
}

func (x *TypeArg) GetIntValue() int64 {
	if x, ok := x.GetValue().(*TypeArg_IntValue); ok {
		return x.IntValue
	}
	return 0
}

func (x *TypeArg) GetBoolValue() bool {
	if x, ok := x.GetValue().(*TypeArg_BoolValue); ok {
		return x.BoolValue
	}
	return false
}

func (x *TypeArg) GetStringValue() string {
	if x, ok := x.GetValue().(*TypeArg_StringValue); ok {
		return x.StringValue
	}
	return ""
}

func (x *TypeArg) GetIdent() string {
	if x, ok := x.GetValue().(*TypeArg_Ident); ok {
		return x.Ident
	}
	return ""
}

type isTypeArg_Value interface {
	isTypeArg_Value()
}

type TypeArg_Type struct {
	Type *TypeExpr `protobuf:"bytes,2,opt,name=type,proto3,oneof"`
}

type TypeArg_IntValue struct {
	IntValue int64 `protobuf:"varint,3,opt,name=int_value,json=intValue,proto3,oneof"`
}

type TypeArg_BoolValue struct {
	BoolValue bool `protobuf:"varint,4,opt,name=bool_value,json=boolValue,proto3,oneof"`
}

type TypeArg_StringValue struct {
	StringValue string `protobuf:"bytes,5,opt,name=string_value,json=stringValue,proto3,oneof"`
}

type TypeArg_Ident struct {
	Ident string `protobuf:"bytes,6,opt,name=ident,proto3,oneof"`
}

func (*TypeArg_Type) isTypeArg_Value() {}

func (*TypeArg_IntValue) isTypeArg_Value() {}

func (*TypeArg_BoolValue) isTypeArg_Value() {}

func (*TypeArg_StringValue) isTypeArg_Value() {}

func (*TypeArg_Ident) isTypeArg_Value() {}
...
type Column struct {
	...
	TypeExpr     *TypeExpr   `protobuf:"bytes,18,opt,name=type_expr,json=typeExpr,proto3" json:"type_expr,omitempty"`
}
...
func (x *Column) GetTypeExpr() *TypeExpr {
	if x != nil {
		return x.TypeExpr
	}
	return nil
...
var file_plugin_codegen_proto_rawDesc = []byte{
	...
	,
	...
	0x52, 0x0b, 0x73, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x16, 0x0a,
	0x05, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x05,
	0x69, 0x64, 0x65, 0x6e, 0x74, 0x42, 0x07, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0xbd,
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x61, 0x72, 0x72, 0x61, 0x79, 0x44, 0x69, 0x6d, 0x73, 0x12,
	0x2d, 0x0a, 0x09, 0x74, 0x79, 0x70, 0x65, 0x5f, 0x65, 0x78, 0x70, 0x72, 0x18, 0x12, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x10, 0x2e, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x2e, 0x54, 0x79, 0x70, 0x65,
	0x45, 0x78, 0x70, 0x72, 0x52, 0x08, 0x74, 0x79, 0x70, 0x65, 0x45, 0x78, 0x70, 0x72, 0x22, 0x94,
	...
	0x74, 0x61, 0x62, 0x6c, 0x65, 0x22, 0x5f, 0x0a, 0x09, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74,
	...
	0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x87, 0x02, 0x0a, 0x0f, 0x47, 0x65, 0x6e, 0x65, 0x72,
	0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2c, 0x0a, 0x08, 0x73, 0x65,
	...
	0x5f, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x26, 0x0a, 0x0e, 0x67, 0x6c, 0x6f, 0x62,
	0x61, 0x6c, 0x5f, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0c,
	0x52, 0x0e, 0x67, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x5f, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	...
	0x65, 0x52, 0x05, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x32, 0x4f, 0x0a, 0x0e, 0x43, 0x6f, 0x64, 0x65,
	0x67, 0x65, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3d, 0x0a, 0x08, 0x47, 0x65,
	0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x12, 0x17, 0x2e, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x2e,
	0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x18, 0x2e, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x2e, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74,
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x7c, 0x0a, 0x0a, 0x63, 0x6f, 0x6d,
...
var file_plugin_codegen_proto_goTypes = []interface{}{
	...
	(*TypeExpr)(nil),         // 9: plugin.TypeExpr
	(*TypeArg)(nil),          // 10: plugin.TypeArg
...
var file_plugin_codegen_proto_depIdxs = []int32{
	...
	16, // 1: plugin.Codegen.process:type_name -> plugin.Codegen.Process
	17, // 2: plugin.Codegen.wasm:type_name -> plugin.Codegen.WASM
	...
	11, // 8: plugin.Table.columns:type_name -> plugin.Column
	10, // 9: plugin.TypeExpr.args:type_name -> plugin.TypeArg
	9,  // 10: plugin.TypeArg.type:type_name -> plugin.TypeExpr
	8,  // 11: plugin.Column.table:type_name -> plugin.Identifier
	8,  // 12: plugin.Column.type:type_name -> plugin.Identifier
	8,  // 13: plugin.Column.embed_table:type_name -> plugin.Identifier
	9,  // 14: plugin.Column.type_expr:type_name -> plugin.TypeExpr
	11, // 15: plugin.Query.columns:type_name -> plugin.Column
	13, // 16: plugin.Query.params:type_name -> plugin.Parameter
	8,  // 17: plugin.Query.insert_into_table:type_name -> plugin.Identifier
	11, // 18: plugin.Parameter.column:type_name -> plugin.Column
	1,  // 19: plugin.GenerateRequest.settings:type_name -> plugin.Settings
	3,  // 20: plugin.GenerateRequest.catalog:type_name -> plugin.Catalog
	12, // 21: plugin.GenerateRequest.queries:type_name -> plugin.Query
	0,  // 22: plugin.GenerateResponse.files:type_name -> plugin.File
	14, // 23: plugin.CodegenService.Generate:input_type -> plugin.GenerateRequest
	15, // 24: plugin.CodegenService.Generate:output_type -> plugin.GenerateResponse
...
func file_plugin_codegen_proto_init() {
	...
	file_plugin_codegen_proto_msgTypes[10].OneofWrappers = []interface{}{
		(*TypeArg_Type)(nil),
		(*TypeArg_IntValue)(nil),
		(*TypeArg_BoolValue)(nil),
		(*TypeArg_StringValue)(nil),
		(*TypeArg_Ident)(nil),
	}
	type x struct{}
