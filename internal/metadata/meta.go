...
type Metadata struct {
	...
	// SwitchGroup is set on queries generated by expanding a sqlc.switch() macro.
	// All branches of the same macro share the value (the original query name),
	// letting codegen give them a single shared Params/Row struct.
	SwitchGroup string
}
