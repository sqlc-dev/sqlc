...
var file_python_ast_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x03, 0x61, 0x73, 0x74, 0x22, 0xe4, 0x02, 0x0a, 0x04, 0x4e, 0x6f, 0x64, 0x65,
	...
	0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x42, 0x06, 0x0a, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x22, 0x1b,
	0x0a, 0x05, 0x41, 0x6c, 0x69, 0x61, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x71, 0x0a, 0x09, 0x41,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x22, 0xb8,
	...
	0x61, 0x74, 0x6f, 0x72, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x22, 0x29, 0x0a, 0x06, 0x49, 0x6d, 0x70,
...
var file_python_ast_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_python_ast_proto_goTypes = []interface{}{
	(*Node)(nil),       // 0: ast.Node
	(*Alias)(nil),      // 1: ast.Alias
	(*AnnAssign)(nil),  // 2: ast.AnnAssign
	(*ClassDef)(nil),   // 3: ast.ClassDef
	(*Import)(nil),     // 4: ast.Import
	(*ImportFrom)(nil), // 5: ast.ImportFrom
	(*Module)(nil),     // 6: ast.Module
	(*Name)(nil),       // 7: ast.Name
	(*Subscript)(nil),  // 8: ast.Subscript
}
var file_python_ast_proto_depIdxs = []int32{
	3,  // 0: ast.Node.class_def:type_name -> ast.ClassDef
	4,  // 1: ast.Node.import:type_name -> ast.Import
	5,  // 2: ast.Node.import_from:type_name -> ast.ImportFrom
	6,  // 3: ast.Node.module:type_name -> ast.Module
	1,  // 4: ast.Node.alias:type_name -> ast.Alias
	2,  // 5: ast.Node.ann_assign:type_name -> ast.AnnAssign
	7,  // 6: ast.Node.name:type_name -> ast.Name
	8,  // 7: ast.Node.subscript:type_name -> ast.Subscript
	7,  // 8: ast.AnnAssign.target:type_name -> ast.Name
	0,  // 9: ast.AnnAssign.annotation:type_name -> ast.Node
	0,  // 10: ast.ClassDef.bases:type_name -> ast.Node
	0,  // 11: ast.ClassDef.keywords:type_name -> ast.Node
	0,  // 12: ast.ClassDef.body:type_name -> ast.Node
	0,  // 13: ast.ClassDef.decorator_list:type_name -> ast.Node
	0,  // 14: ast.Import.names:type_name -> ast.Node
	0,  // 15: ast.ImportFrom.names:type_name -> ast.Node
	0,  // 16: ast.Module.body:type_name -> ast.Node
	7,  // 17: ast.Subscript.value:type_name -> ast.Name
	7,  // 18: ast.Subscript.slice:type_name -> ast.Name
