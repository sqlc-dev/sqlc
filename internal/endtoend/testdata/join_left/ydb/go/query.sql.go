...
func (q *Queries) GetMayors(ctx context.Context) ([]int32, error) {
...
func (q *Queries) GetMayorsOptional(ctx context.Context) ([]int32, error) {
...
func (q *Queries) GetSuggestedUsersByID(ctx context.Context, arg GetSuggestedUsersByIDParams) ([]GetSuggestedUsersByIDRow, error) {
	rows, err := q.db.QueryContext(ctx, getSuggestedUsersByID, arg.UserID, arg.UserLimit)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
