...
WHERE
  full_name IN (/*SLICE:full_names*/?)
`

func (q *Queries) GetFullNames(ctx context.Context, fullNames []interface{}) ([]string, error) {
	query := getFullNames
...
func (q *Queries) GetFullNames2(ctx context.Context, fullNames []interface{}) ([]string, error) {
	query := getFullNames2
	var queryParams []interface{}
	if len(fullNames) > 0 {
		for _, v := range fullNames {
